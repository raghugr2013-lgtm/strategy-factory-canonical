...
OPTIONAL_VARS = (
    ...
    "SUPERVISOR_ORCHESTRATOR_CRON",
    "SUPERVISOR_MUTATION_CRON",
    "SUPERVISOR_FACTORY_EVAL_CRON",
    "SUPERVISOR_META_LEARNING_CRON",
    "SUPERVISOR_GOVERNANCE_CRON",
    "SUPERVISOR_BACKEND_STATUS_URL",
    "SUPERVISOR_BACKEND_TOKEN",
    "SUPERVISOR_BACKEND_TIMEOUT_S",
)
