...
`https://strategy-factory-v1.preview.emergentagent.com/` returns HTTP 200 with title `Emergent | Fullstack App`. Logged in with the seeded admin credentials and screenshotted at 1920×800. Observed surfaces (all required by handoff §14):
