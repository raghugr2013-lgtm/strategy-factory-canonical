...
|---|---|---|
| Emergent preview (Kubernetes pod) | Runtime validation of the exact same code that ships in the tarball | https://strategy-prod-main.preview.emergentagent.com |
...
Every service artefact that will be built into a Docker image is running right now in the preview at https://strategy-prod-main.preview.emergentagent.com — this is the **same source code** that goes into the tarball:
